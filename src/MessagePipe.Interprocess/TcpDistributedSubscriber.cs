...
public sealed class TcpDistributedSubscriber<TKey, TMessage> : IDistributedSubscriber<TKey, TMessage>
{
    ...
    [MessagePipe.Interprocess.Internal.PreserveAttribute]
    public TcpDistributedSubscriber(MessagePipe.Interprocess.Workers.TcpWorker worker, MessagePipeInterprocessTcpOptions options, IAsyncSubscriber<IInterprocessKey, IInterprocessValue> subscriberCore, FilterAttachedMessageHandlerFactory syncHandlerFactory, FilterAttachedAsyncMessageHandlerFactory asyncHandlerFactory)
    {
    ...
    [MessagePipe.Interprocess.Internal.PreserveAttribute]
    public TcpDistributedSubscriber(MessagePipe.Interprocess.Workers.TcpWorker worker, MessagePipeInterprocessTcpUdsOptions options, IAsyncSubscriber<IInterprocessKey, IInterprocessValue> subscriberCore, FilterAttachedMessageHandlerFactory syncHandlerFactory, FilterAttachedAsyncMessageHandlerFactory asyncHandlerFactory)
    {
        this.options = options;
        this.subscriberCore = subscriberCore;
        this.syncHandlerFactory = syncHandlerFactory;
